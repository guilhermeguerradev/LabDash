  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-3 flex-wrap">
      ...
      <button
        ...
        className="cursor-pointer px-4 py-2 bg-purple-400/10 border border-purple-400/20 text-purple-400 text-sm font-medium rounded-xl hover:bg-purple-400/20 transition-all duration-200"
      >
        Filtrar
      </button>
      ...
      <button
        onClick={handleClear}
        className="cursor-pointer px-4 py-2 border border-white/10 text-gray-400 text-sm font-medium rounded-xl hover:bg-white/5 transition-all duration-200"
      >
        Limpar
      </button>
    </div>
